...
export function settings() {
  return {
    ...
    answerConcurrency: overlay.answerConcurrency ?? num('ANSWER_CONCURRENCY', 12),
    extractConcurrency: overlay.extractConcurrency ?? num('EXTRACT_CONCURRENCY', 5),
    extractBatchSize: overlay.extractBatchSize ?? num('EXTRACT_BATCH_SIZE', 6),
